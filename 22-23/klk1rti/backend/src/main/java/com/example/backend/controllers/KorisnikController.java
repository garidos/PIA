...
public class KorisnikController {
    ...
    @GetMapping("/getSlobodniDizajneri")
    public ArrayList<Korisnik> getSlobodniDizajneri() {
        return repo.getSlobodniDizajneri();
    }
    
    @GetMapping("/getKorisnikByKorIme/{ime}")
    public Korisnik getKorisnikByKorIme(@PathVariable String ime) {
        return repo.getKorisnikByKorIme(ime);
    }
}
